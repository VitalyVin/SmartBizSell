...
$faqs = [
    ...
    [
        'question' => 'Можно ли подобрать инвестора без регистрации?',
        'answer' => 'Да. На странице /investor-match.php доступен публичный сервис: заполните короткую анкету о бизнесе, и AI сформирует краткое описание компании и предложит ТОП-5 потенциальных инвесторов из каталога SmartBizSell. Для отправки инвестиционного тизера потребуется регистрация и расширенная анкета продавца.'
    ],
    [
