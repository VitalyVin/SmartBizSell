        ...
        <div class="service-content">
            <div class="service-main">
                ...
                <ol>
                    ...
                    <li><strong>Автоматическая генерация материалов:</strong> ИИ создает тизер, DCF модель и оценку</li>
                    <li><strong>Модерация и доработка:</strong> команда проверяет материалы и при необходимости корректирует</li>
            ...
            <div class="service-sidebar">
                ...
                <div class="service-card">
                    <h3>Сроки</h3>
                    <p>Подготовка тизера и оценки: <strong>1-2 дня</strong></p>
