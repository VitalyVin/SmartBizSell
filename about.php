...
<body>
    ...
    <div class="about-page">
        ...
        <div class="about-section">
            ...
            <ol>
                <li><strong>Автоматизация:</strong> продавец запускает создание тизера в личном кабинете, ИИ обрабатывает данные и создает базовые материалы за минуты</li>
                <li><strong>Проверка:</strong> продавец отправляет тизер на модерацию, команда проверяет материалы за несколько часов и модерирует перед публикацией</li>
